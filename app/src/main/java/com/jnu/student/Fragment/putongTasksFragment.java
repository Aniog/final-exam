...
public class putongTasksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dungeon_tasks.add(new Tasks("好好吃一顿早饭",10));
        dungeon_tasks.add(new Tasks("边听歌边跑步",10));
        dungeon_tasks.add(new Tasks("十一点之前入睡",15));
        tasksAdapter = new putongTasksFragment.TasksAdapter(dungeon_tasks);
